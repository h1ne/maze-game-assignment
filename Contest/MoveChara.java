...
public class MoveChara {
    ...
    private final String pngPathPre = getCharaName();
    private final String pngPathSuf = ".png";
    private static final String[] charaNameIndex = { "cat", "shizuppy", "car" };
    ...
    static String getCharaName() {
        ...
        String charaName = "png/" + charaNameIndex[rand.nextInt(3)];
        return charaName;
    }
    ...
    private boolean isMovable(int dx, int dy) {
        if (mapData.getMap(posX + dx, posY + dy) == MapData.TYPE_WALL) {
            ...
            return true;
        } else if (mapData.getMap(posX + dx, posY + dy) == 6) {
            return true;
        } else if (mapData.getMap(posX + dx, posY + dy) == 7) {
            return true;
        }
        return false;
    }
    ...
    public boolean isAtGoal() {
        return mapData.getMap(posX, posY) == MapData.TYPE_GOAL;
    }
